...
**Dashes** — Optional dash automation for returning to a target or reaching safety faster. These options are off by default and can very likely kill you in some fights. Each dash type has its own minimum distance and job allow-list, including backstep-style safety dashes such as Elusive Jump, Yaten, Repelling Shot, Hell's Egress, and Displacement.
